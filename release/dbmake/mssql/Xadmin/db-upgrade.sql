...
-- RXPS-48532 - START 
ALTER TABLE [dbo].[cfg_tender_options_change] ALTER COLUMN [fiscal_tndr_id] varchar(60) null
GO
-- RXPS-48532 - END
...
BEGIN
    ALTER TABLE dtx_def ALTER COLUMN table_name varchar(128);
...
BEGIN
  ALTER TABLE ocds_subtask_details ADD path varchar(120) NULL;
...
BEGIN
    DECLARE @v_subtask_id VARCHAR(30),@v_organization_id INT, @sql nvarchar(max);
...
BEGIN
  EXEC('ALTER TABLE dat_legal_entity_change ADD legal_form varchar(60) NULL');
...
BEGIN
  EXEC('ALTER TABLE dat_legal_entity_change ADD social_capital varchar(60) NULL');
...
BEGIN
  EXEC('ALTER TABLE dat_legal_entity_change ADD companies_register_number varchar(30) NULL');
...
BEGIN
  EXEC('ALTER TABLE dat_legal_entity_change ADD fax_number varchar(32) NULL');
...
BEGIN
  EXEC('ALTER TABLE dat_legal_entity_change ADD phone_number varchar(32) NULL');
...
BEGIN
  EXEC('ALTER TABLE dat_legal_entity_change ADD web_site varchar(254) NULL');
...
ALTER TABLE QRTZ_FIRED_TRIGGERS ALTER COLUMN TRIGGER_NAME VARCHAR(200) NOT NULL;
GO
...
ALTER TABLE QRTZ_FIRED_TRIGGERS ALTER COLUMN TRIGGER_GROUP VARCHAR(200) NOT NULL;
GO
...
ALTER TABLE DTX_RELATIONSHIP ALTER COLUMN OTHER_DTX_NAME VARCHAR(256);
GO
...
ELSE
  BEGIN
    EXEC('    ALTER TABLE DAT_RETAIL_LOCATION_P_CHANGE ADD [RECORD_STATE] VARCHAR(30)');
...
ALTER TABLE CFG_CODE_VALUE ALTER COLUMN DESCRIPTION VARCHAR(256);
GO
...
ALTER TABLE DTX_FIELD ALTER COLUMN COLUMN_NAME VARCHAR(30);
GO
...
BEGIN
  ALTER TABLE dat_legal_entity_change ADD establishment_code varchar(30) NULL;
...
BEGIN
  ALTER TABLE dat_legal_entity_change ADD registration_city varchar(254) NULL;
