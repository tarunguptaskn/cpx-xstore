...
set JRE_UPDATE_DIRECTORY=%ENVIRONMENT_DIRECTORY%jre_updates
set PREVIOUS_JRE_DIRECTORY=%ENVIRONMENT_DIRECTORY%jre_previous
set ENV_MARKER_DIRECTORY=%ENVIRONMENT_DIRECTORY%marker
set ERR_MARKER_FILE=%ENV_MARKER_DIRECTORY%\jre_upgrade.err
...
if NOT EXIST %JAVA_HOME%\bin\hardware-service.exe copy /Y %JRE_DIRECTORY%\bin\java.exe %JAVA_HOME%\bin\hardware-service.exe
...
:XENV_UPGRADE
:: Install any pending Hardware Service updates
CALL :LOG ==========================================
CALL :LOG Looking for Hardware Service upgrades...
CALL :LOG ==========================================
...
CALL :LOG ====================================================================
CALL :LOG Running Hardware Service update %CURRENT_JAR_FILE%
CALL :LOG ====================================================================
...
START %JAVA_HOME%\bin\java -Dreboot.when.finished=true -jar %JAR_TO_EXECUTE%
