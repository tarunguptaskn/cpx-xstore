...
# Application
APP_NAME="xservices"
APP_LONG_NAME="Xservices"
ENVIRONMENT_DIRECTORY="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)/.."
export JAVA_HOME=$(cd "${ENVIRONMENT_DIRECTORY}/../jre" && pwd)
export JAVA=$JAVA_HOME/bin/xservices
